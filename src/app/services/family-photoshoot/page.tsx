...
const highlights = [
  {
    icon: Users,
    title: "All Family Sizes",
    description:
      "Whether it's a couple, growing family, or multi-generational gathering, we welcome families of all sizes.",
  },
  {
    icon: Heart,
    title: "Natural Connection",
    description:
      "We focus on capturing authentic interactions, real laughter, and the genuine love between family members.",
  },
  {
    icon: MapPin,
    title: "Studio or Outdoor",
    description:
      "Choose between our fully equipped studio or a beautiful outdoor location for your session.",
  },
  {
    icon: Palette,
    title: "Styled Sessions",
    description:
      "We guide you on outfits, colors, and coordination to ensure your family photos look stunning and cohesive.",
  },
];

const includes = [
  "Pre-session consultation for styling and location planning",
  "1 to 1.5 hour professional photoshoot session",
  "Guidance on outfit coordination and color palettes",
  "Multiple group and individual compositions",
  "Candid and posed portrait combinations",
...
const sessionTypes = [
  {
    title: "Studio Family Portraits",
    description:
      "Classic, timeless family portraits in our professionally lit studio with a variety of backdrops. Perfect for clean, elegant photos ideal for framing and gifting.",
  },
  {
    title: "Outdoor Family Sessions",
    description:
      "Natural, relaxed sessions at beautiful outdoor locations during golden hour. Parks, gardens, and scenic spots make for stunning, lifestyle-inspired portraits.",
  },
  {
    title: "Special Occasion Shoots",
    description:
      "Celebrating an anniversary, reunion, festival, or milestone? We create themed sessions to mark your family's special moments with beautiful imagery.",
  },
];

const faqs = [
  {
    question: "How should we coordinate our outfits?",
    answer:
      "We recommend choosing a color palette of 2-3 complementary colors rather than matching outfits. Neutral tones with one accent color work beautifully. Avoid large logos and busy patterns. We'll provide detailed guidance during the consultation.",
  },
  {
    question: "Can we include pets in the photoshoot?",
    answer:
      "Yes! Pets are family too. We love including furry family members in the session. Just let us know during the consultation so we can plan accordingly.",
  },
  {
    question: "What if the kids are uncooperative?",
    answer:
      "Completely normal! We're experienced with children of all ages and temperaments. We use games, play, and plenty of patience to capture genuine smiles and interactions. Some of the best photos happen during unscripted moments.",
  },
  {
    question: "Do you offer extended family / group sessions?",
    answer:
      "Absolutely! We offer extended family sessions for grandparents, cousins, and large groups. These sessions are slightly longer to accommodate all the combinations and group shots you'd like.",
  },
];
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed text-base md:text-lg">
                <p>
                  ...
                  — we capture the real connections, inside jokes, warm embraces,
                  and joyful chaos that make your family special.
                </p>
                <p>
                  Whether it&apos;s your first family portrait with a new baby,
                  a milestone celebration, or simply a way to freeze this moment
                  in time, we create images that you&apos;ll look back on with
