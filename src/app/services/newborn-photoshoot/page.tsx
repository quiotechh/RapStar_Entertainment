...
const highlights = [
  {
    ...
    title: "Safety First",
    description:
      "Our photographers are trained in newborn safety. Every pose and prop is carefully chosen to keep your baby secure.",
  },
  {
    icon: Heart,
    title: "Gentle Handling",
    description:
      "We handle your newborn with the utmost care, patience, and tenderness throughout the session.",
  },
  {
    icon: Clock,
    title: "Perfect Timing",
    description:
      "Best within the first 5-14 days when babies are naturally sleepy and curl into those adorable poses.",
  },
  {
    icon: Sparkles,
    title: "Artistic Posing",
    description:
      "From classic wraps to creative setups, we create magazine-worthy portraits of your newest family member.",
  },
];

const includes = [
  "Pre-session consultation and planning call",
  "2 to 3 hour professional studio session",
  "Curated collection of wraps, blankets, and headbands",
  "Multiple setups including basket, wrap, and prop poses",
  "Parent and sibling portraits included",
  "Professional retouching of every delivered image",
  "25-35 high-resolution edited digital images",
...
const tips = [
  {
    title: "Book Early",
    description:
      "We recommend booking during your pregnancy (around 6-7 months) to secure your spot. We'll schedule the exact date once your baby arrives.",
  },
  {
    title: "Best Age",
    description:
      "The ideal window is 5-14 days after birth. At this age, babies are naturally sleepy, flexible, and curl beautifully into those classic newborn poses.",
  },
  {
    title: "Feed Before Session",
    description:
      "A full, sleepy baby is a happy baby! Feed your little one right before the session or upon arrival at the studio for the best results.",
  },
  {
    title: "Keep Baby Warm",
    description:
      "Our studio is kept warm and cozy. Dress your baby in easy-to-remove clothing — a simple onesie or sleep suit works perfectly.",
  },
];

const faqs = [
  {
    question: "How old should my baby be for the session?",
    answer:
      "The ideal age is 5-14 days old. At this stage, babies sleep deeply and naturally curl into those adorable poses. However, we can photograph babies up to 4 weeks old — sessions just take a bit longer as older newborns are more alert.",
  },
  {
    question: "Is newborn photography safe?",
    answer:
      "Absolutely. Safety is our top priority. Our photographers are specifically trained in newborn posing and handling. We never force poses, always use spotters, and maintain a warm, clean studio environment.",
  },
  {
    question: "How long does a newborn session take?",
    answer:
      "Plan for 2-3 hours. Newborn sessions take time because we work around your baby's feeding and sleep schedule. We never rush — we want both you and your baby to be comfortable.",
  },
  {
    question: "When should I book my newborn session?",
    answer:
      "We recommend booking during your second or third trimester. This ensures we can reserve your estimated due date window. Once baby arrives, simply let us know and we'll confirm the session date.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-purple-200 max-w-3xl mx-auto font-light leading-relaxed">
              Preserve the tiniest details of your newborn&apos;s first days
              with delicate, artistic portraits that you&apos;ll cherish for a
              lifetime.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed text-base md:text-lg">
                <p>
                  Those first few days are fleeting and incredibly precious. Our
                  newborn photography sessions are designed to capture the pure
                  innocence, delicate features, and overwhelming love that
                  surrounds your newest family member.
                </p>
                <p>
                  With specialized training in newborn safety and posing, we
                  create stunning, artistic portraits in a warm, comfortable
                  studio environment. Every tiny toe, every soft curl, every
                  peaceful expression is preserved forever.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto font-light">
              A safe, warm, and nurturing environment for your baby&apos;s first
              portrait session.
            </p>
          </motion.div>
      ...
      <section className="py-16 sm:py-20 md:py-28 bg-linear-to-b from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto font-light">
              Simple tips to help ensure a smooth and beautiful newborn session.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            {tips.map((tip, index) => (
              ...
              >
                <span className="w-10 h-10 rounded-full bg-purple-900/40 text-purple-400 font-semibold text-lg flex items-center justify-center mb-4">
                  {index + 1}
                </span>
      ...
      <section className="py-16 sm:py-20 md:py-28 bg-linear-to-b from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto font-light">
              Delicate newborn portraits crafted with love and artistry.
            </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
            {[
              "/services/newborn/newborn1.jpeg",
              "/services/newborn/newborn2.jpeg",
              "/services/newborn/newborn3.jpeg",
              "/services/newborn/newborn4.jpeg",
              "/services/newborn/newborn.jpeg",
              "/services/newborn/new born.webp",
            ].map((src, index) => (
              <motion.div
                key={src}
              ...
              >
                <Image
                  src={src}
                  alt={`Newborn gallery image ${index + 1}`}
                  fill
                  className="object-cover"
                />
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-purple-200 max-w-2xl mx-auto font-light leading-relaxed mb-10">
              These first days are fleeting. Book your newborn session during
              pregnancy to secure your spot, and let us preserve these precious
              moments forever.
            </p>
