        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <Link
                href="https://www.instagram.com/rapstarentertainments/"
                target="_blank"
              ...
              <Link
                href="https://www.facebook.com/rapstarentertainments"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-violet-600 transition-colors duration-300"
                aria-label="Facebook"
              ...
              <Link
                href="https://www.youtube.com/@RapstarEntertainmentsLLP"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-violet-600 transition-colors duration-300"
                aria-label="YouTube"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">+91 8383913667</p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">
                    H No F 621, Palam Extension, Ramphal Chowk Rd, Sector 7
                    Dwarka, Delhi 110077
                  </p>
                  <p className="text-gray-500 text-xs font-light">
                    Visit Our Studio
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm font-light">
            &copy; {new Date().getFullYear()} Rapstar Entertainment. All rights
            reserved.
          </p>
          <div className="flex gap-6">
            <Link
              href="/privacy"
              className="text-gray-500 hover:text-violet-400 text-sm font-light transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
